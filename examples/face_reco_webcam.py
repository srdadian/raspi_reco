...
person1 = face_recognition.load_image_file("images/stephane-dadian.JPG")
person1_face_encoding = face_recognition.face_encodings(person1)[0]
person2 = face_recognition.load_image_file("images/louise.jpg")
